 ...
 * @author Fernando
 */
public class alterainstituicao extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        inst.setId(Integer.parseInt(request.getParameter("textId")));
        ...
        inst.setLogo(request.getParameter("file"));
        instdao.addOrUpd(inst);
        String nome = inst.getNome_fantasia();
