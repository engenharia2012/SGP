<%-- 
    Document   : notificar_questao
    Created on : 08/04/2013, 15:28:03
    Author     : jose
--%>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>            
            <fieldset >
              ...
              <form id="form_validacao" action="NotificarQuestao.do" method="post">
                <div class="rowElem"><label>Nº da Questão:</label><input type="text" name="questao" id="questao"/></div>
                <div class="rowElem"><label>Texto da Notificação:</label><input type="text" name="notificacao" id="notificacao" /></div>
