...
<div class="container">
  ...
  <ul class="formulario">
    <fieldset>
	   <legend>Cadastro 햞ea</legend>
	    <FORM name="Cadastro_Area" action="cadastraarea.do" enctype="multipart/formdata" class="validate" method="post">
                <p>
                <label>햞ea:</label>
                <input maxlength="80" size="60" name="textNomeArea" id="nome" class="required">
		<span>Informe o nome da 햞ea</span>
                </p>
                </br></br>
