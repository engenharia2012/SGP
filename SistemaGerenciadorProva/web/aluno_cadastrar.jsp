<%-- 
    Document   : aluno_cadastrar
    Created on : 31/03/2013, 16:49:51
    Author     : jose
--%>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>
            <fieldset >
              ...
              <form id="form_validacao" action="CadastrarAluno.do" method="post">
                ...
                <div class="rowElem"><label>Rpetir Senha:</label><input type="text" name="senha" id="rsenha_al" /></div>
