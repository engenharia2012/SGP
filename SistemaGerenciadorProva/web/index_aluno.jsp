...
<div class="container">
  ...
  <ul class="menu">
	<li><a href="#" title="Sobre">Alunos</a>
            ...
            <li><a href="processaareaexcluir.do" title="Deletar Áreas">Solicitar Excluir</a>
            </li>                    
        </ul>
  ...
  <ul class="menu_vertical">Menu do Aluno</ul>
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
      <p align="right">Seja bem vindo aluno Fulano! Para sair do sistema <a href="logout.jsp">Clique aqui!</a></p><!--ADAPTAÇÃO DE PÁGINA -->
  <ul class="formulario">
    <fieldset>
