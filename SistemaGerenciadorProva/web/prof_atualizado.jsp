<%-- 
    Document   : prof_atualizado
    Created on : 31/03/2013, 14:24:36
    Author     : jose
--%>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>            
<fieldset >
              <legend>Professor Atualizado com Sucesso</legend>
              <form id="form_validacao" action="" method="post">
                  <%Professor p = (Professor) request.getAttribute("pro");%>
                  <div class="rowElem"><label>Nome:</label><input type="text" name="nome" id="nome" value="<%out.print(p.getNome());%>"/></div>
                <div class="rowElem"><label>Email:</label><input type="text" name="email" id="email" value="<%out.print(p.getEmail());%>"/></div><br /><br />
