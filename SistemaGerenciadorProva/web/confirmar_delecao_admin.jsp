<%-- 
    Document   : confirmar_delecao_adim
              ...
              <form id="form_validacao" action="DeletarAdministradorConfirmado.do" method="post">
                <%  Administrador admin = (Administrador) request.getAttribute("admin");
                    ...
                    if (admin.getNome() != null) { %>
                        ...
                        <input type="hidden" name="admin_atual" value="<%out.print(admin.getAdmin_atual());%>"/></div>
                        <input type="hidden" name="senha" value="<%out.print(admin.getSenha());%>"/></br></br>
