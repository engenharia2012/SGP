<%-- 
    ...
    Created on : 21/03/2013, 06:38:36
    Author     : jose
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="container">
	  ...
	  <li><a href="#" title="Sobre">Aluno</a>
            <ul>
              <li><a href="#" title="Web design">Cadastrar</a></li>            
              <li><a href="#" title="SEO">Editar</a></li>
              <li><a href="#" title="Design gr&aacute;fico">Excluir</a></li>
              <li><a href="#" title="Design gr&aacute;fico">Listar</a></li>
            </ul>
          </li>
          <li><a href="#" title="Sobre">Administrador</a>
            <ul>
              <li><a href="cadastrar_admin.jsp" title="Web design">Cadastrar</a></li>            
              <li><a href="atualizar_administrador.jsp" title="SEO">Editar</a></li>
              <li><a href="deletar_administrador.jsp" title="Design gr&aacute;fico">Excluir</a></li>
              <li><a href="buscar_administrador.jsp" title="Design gr&aacute;fico">Buscar</a></li>
            </ul>
          </li>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>
            <fieldset >
              ...
              <form id="form_validacao" action="CadastrarAdministrador.do" method="post">
                ...
                <div class="rowElem"><label>Repetir Senha:</label><input type="text" name="senha" id="rsenha_al" /></div>
