<%-- 
    Document   : prof_cadastrado
    Created on : 31/03/2013, 07:33:33
    Author     : jose
--%>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>            
            <fieldset >
              <legend>Professor Cadastrado</legend>
              <%
              Professor p = (Professor) request.getAttribute("p_cad");
              %>
              <form id="form_validacao" action="" method="post">
                ...
                <div class="rowElem"><label>Instituição:</label><input type="text" name="inst" id="inst" value="<%out.print(p.getInst().getNome_fantasia());%>"/></div>
                <div class="rowElem"><label>Area:</label><input type="text" name="area" id="area" value="<%out.print(p.getArea().getNome());%>"/></div>
              </form>
