<%-- 
    ...
    Created on : 21/03/2013, 06:39:10
    Author     : jose
--%>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>
            <fieldset >
              ...
              <form id="form_validacao" action="" method="post">
                <%Aluno a = (Aluno) request.getAttribute("al");%>
                <h2>Cadastrado com sucesso!</h2>
                <div class="rowElem"><label>Nome:</label><input type="text" name="nome" id="nome_al" value="<%out.print(a.getNome());%>"/></div>
                <div class="rowElem"><label>Email:</label><input type="text" name="email" id="email_al" value="<%out.print(a.getEmail());%>"/></div>
              </form></br></br>
              <a href='aluno_inicial.jsp'>Voltar a pagina inicial</a>
            </fieldset>
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>            
         </ul><!-- end .content -->
       </div>
