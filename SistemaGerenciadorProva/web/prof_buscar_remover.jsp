<%-- 
    Document   : prof_buscar_remover
    Created on : 31/03/2013, 15:32:01
    Author     : jose
--%>
...
<%--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%--%>            
            <fieldset >
              <legend>Professor a Remover</legend>
              <form id="form_validacao" action="BuscarProfessorDeletar.do" method="post">
